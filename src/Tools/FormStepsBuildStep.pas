...
type
	TStepsBuildStepForm = class(TForm)
		Label1: TLabel;
		Label2: TLabel;
		Label3: TLabel;
...
var
	StepsBuildStepForm: TStepsBuildStepForm;
...
procedure TStepsBuildStepForm.NumberBox1Change(Sender: TObject);
	begin
...
procedure TStepsBuildStepForm.RadioButton1Change(Sender: TObject);
	begin
	NumberBox2.Enabled:= RadioButton1.IsChecked;
	end;

function TStepsBuildStepForm.ShowAddFrames(const AMove: Integer): TModalResult;
	begin
