...
function  RangeEncoder: TRangeEncoder;

procedure RangeEncoderCreate;
procedure RangeEncoderFree;
...
threadvar
	FRangeEncoder: TRangeEncoder;


function  RangeEncoder: TRangeEncoder;
	begin
	Result:= FRangeEncoder;
    end;

procedure RangeEncoderCreate;
	begin
	FRangeEncoder:= TRangeEncoder.Create;
	end;
